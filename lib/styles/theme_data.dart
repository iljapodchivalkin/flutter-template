...
class FlutterTemplateTheme {
  ...
  static final _instanceDark = FlutterTemplateTheme._(
    isDarkTheme: true,
    main: ThemeColors.accentBuild96,
    ...
    canvas: ThemeColors.main20,
    level1: ThemeColors.main24,
    level2: ThemeColors.main28,
    level3: ThemeColors.main32,
    level4: ThemeColors.main36,
    strokeDefault: ThemeColors.neutral76,
    strokeSubtle: ThemeColors.neutral88,
    headingBrandDefault: ThemeColors.systemNegative96,
